...
| 미션 | 충족 화면 | 증빙 SS |
|---|---|---|
| Q5 게시판: 글 CRUD | `#/board`, `#/board/new`, `#/board/post/{id}` | screenshots/Q5/S1·S2·S4 |
| Q5: 댓글 | `#/board/post/{id}` 하단 | screenshots/Q5/S3 |
| Q5: 반응(좋아요/하트/불) | `#/board/post/{id}` 👍❤️🔥 | screenshots/Q5/S3 |
| Q6 쇼핑: 상품 목록 | `#/shop` | screenshots/Q6/S1 |
| Q6: 상품 상세 | `#/shop/product/{id}` | screenshots/Q6/S2 |
| Q6: 장바구니 | `#/shop/cart` | screenshots/Q6/S3 |
| Q6: 주문 + 스냅샷 | `#/shop/orders`, `#/shop/order/{id}` | screenshots/Q6/S4 |
| 인증 (공통 인프라) | 회원가입/로그인 모달 | screenshots/B1/ |
...
| `/api/shop` | 10 (products/product/cart/cart_add/cart_update/cart_clear/order_create/orders/order/...) | products·product 무, 나머지 유 |

총 함수 3개 / 21 endpoint (한도 12개 중 9개 여유)

## 구현 규모
- 백엔드: 953줄 (auth 189 + posts 319 + shop 400 + auth-helper 45)
- 화면: 1,868줄 (단일 SPA)
- DB: 7 테이블 (auth_users, auth_sessions, community_posts, community_comments, community_reactions, shop_products, shop_cart_items, shop_orders, shop_order_items)
