// ===========================================================
// Q5+Q6+Q7+Q8 통합 dev 서버 — Vercel-like routing
//   $ node dev-server.js
...
//   /api/moon?view=...   (me/weather/news/briefing) — 문카페 Q7+Q8
// ===========================================================
...
const moonHandler  = require('./api/moon.js');
...
app.all('/api/moon',  (req, res) => moonHandler(req, res));
